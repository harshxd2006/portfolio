  ...
  return (
    <li className="relative pl-8">
      <span
        ...
        aria-hidden="true"
      />
      <p className="mb-1 font-dm text-[11px] uppercase tracking-[0.2em] text-white/30">{year}</p>
      <h3 className="font-syne text-lg font-bold text-white">{title}</h3>
      <p className="mt-2 max-w-3xl font-dm text-[13px] font-light leading-relaxed text-white/45">
        {description}
      </p>
    </li>
  );
